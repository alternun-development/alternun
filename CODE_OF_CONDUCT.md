...
- **Discrimination**: Discriminatory language, jokes, or behavior
- **Personal Attacks**: Insults, ad hominem attacks, or personal criticism
- **Spam**: Unwanted commercial content, self-promotion, or off-topic content
- **Disruptive Behavior**: Intentionally disrupting discussions or workflows
...
1. **Email**: conduct@alternun.io
2. **GitHub**: [Report an issue](https://github.com/alternun-development/alternun/issues/new?template=code_of_conduct.md)
3. **Discord**: Message any community moderator privately
...
All reports will be kept confidential to the extent possible. We will not share your identity without your permission, except as necessary to investigate the report.

### Response Time

We will respond to all reports within 48 hours and provide an update on our investigation within 7 days.
...
- Ask for help from community leaders if needed
...
We are committed to creating a diverse and inclusive community where everyone feels welcome and valued. We actively encourage participation from people of all backgrounds and experiences.

### Initiatives

- **Mentorship Programs**: Pair experienced contributors with newcomers
- **Outreach**: Reach out to underrepresented groups in tech
- **Accessibility**: Ensure our community spaces are accessible to all
- **Education**: Provide resources on inclusive language and behavior
...
- **Be Respectful**: Consider cultural and language differences
- **Be Constructive**: Focus on solutions, not problems

### Code Reviews

- **Be Helpful**: Provide specific, actionable feedback
- **Be Kind**: Remember that code has feelings too
- **Be Patient**: Understand that everyone learns at their own pace
- **Be Professional**: Maintain professional standards in all reviews
...
This code of conduct is effective as of January 1, 2026 and applies to all community interactions going forward.
