...
import { ThemeProvider, SectionHeaderSkeleton } from '@alternun/ui';
...
function SectionLabel({
  ...
  return (
    <View style={sectionStyles.labelContainer}>
      ...
      <View>
        <Text
          style={[sectionStyles.label, { color: isDark ? 'rgba(232,232,255,0.95)' : '#0f172a' }]}
        >
          {label}
        </Text>
        {subtitle ? (
          <Text
            style={[
              sectionStyles.sublabel,
              { color: isDark ? 'rgba(232,232,255,0.8)' : '#475569' },
            ]}
          >
            {subtitle}
          </Text>
    ...
    >
      ...
      {showOverlay ? (
        <View style={[experienceStyles.overlay, { backgroundColor: palette.overlayBg }]}>
          ...
          <Text
            style={[experienceStyles.overlayDescription, { color: palette.overlayDescription }]}
          >
          ...
          <View style={experienceStyles.overlayActions}>
            ...
            >
              <Text
                style={[
                  experienceStyles.overlaySecondaryText,
  ...
  if (sectionKey === 'compensation') {
    return (
      <View style={experienceStyles.previewBlock}>
        <Text style={[experienceStyles.previewTitle, { color: palette.title }]}>
          Offset Checkout
        </Text>
        <View
          style={[
            experienceStyles.metricRow,
        ...
        >
          ...
          <Text style={[experienceStyles.metricValue, { color: palette.strong }]}>
            Not selected
          </Text>
        </View>
        <View
        ...
        <View style={experienceStyles.previewActions}>
          ...
          >
            <Text
              style={[
                experienceStyles.previewActionSecondaryText,
                { color: palette.secondaryButtonText },
                disabledActionTextStyle,
              ]}
            >
              Issue SBT
            </Text>
  ...
  if (sectionKey === 'portfolio') {
    return (
      <View style={experienceStyles.previewBlock}>
        ...
        <Text style={[experienceStyles.tokenMeta, { color: palette.muted }]}>
          Acquisition: $0.00
        </Text>
        <View style={experienceStyles.previewActions}>
          <TouchableOpacity
      ...
      <View style={experienceStyles.previewBlock}>
        <View style={experienceStyles.feedRow}>
          ...
          <View style={experienceStyles.feedTextColumn}>
            <Text style={[experienceStyles.feedTitle, { color: palette.strong }]}>
              No Airs activity yet
            </Text>
            <Text style={[experienceStyles.feedMeta, { color: palette.muted }]}>
              Connect integrations to stream events
            </Text>
          </View>
        </View>
        <View style={experienceStyles.feedRow}>
          <View
            style={[experienceStyles.feedDotMuted, { backgroundColor: palette.feedDotMuted }]}
          />
          <View style={experienceStyles.feedTextColumn}>
            <Text style={[experienceStyles.feedTitleMuted, { color: palette.muted }]}>
              Ledger reference
            </Text>
