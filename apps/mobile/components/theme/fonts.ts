...
export const ANEK_EXPANDED_FAMILY = 'AnekLatin-Expanded';
...
export const appFonts = {
  ...
  [ANEK_EXPANDED_FAMILY]:
    require('../../assets/fonts/Anek_latin/static/AnekLatin_Expanded-Regular.ttf') as FontSource,
...
export function paragraphFont(style?: StyleProp<TextStyle>): StyleProp<TextStyle> {
  return [{ fontFamily: ANEK_EXPANDED_FAMILY }, style];
}
