...
| ID     | Task                                                    | Phase                |
| ------ | ------------------------------------------------------- | -------------------- |
| P-1-01 | Harden `USE_V2_NAV` flag — runtime + URL + env override | −1 — V1/V2 Isolation |
| P-1-02 | Move V1 layout files into `layouts/v1/`                 | −1 — V1/V2 Isolation |
| P-1-03 | V1/V2 smoke tests (regression guard)                    | −1 — V1/V2 Isolation |
...
**Start order:** P-1-01 → P-1-02 → P-1-03 → P0-01 → P0-02 → P1-01. Phase 1 can be demoed independently of Phase 2. V1 must remain shippable at every step.
