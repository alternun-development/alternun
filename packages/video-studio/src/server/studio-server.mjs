...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  const remotion = spawn('npx', ['remotion', 'studio'], {
    cwd: PROJECT_ROOT,
    stdio: 'inherit',
    detached: true, // Detach child process so it survives parent exit
  });
  ...
  // Keep server running even if Remotion exits
  remotion.on('exit', (code) => {
    if (code === 0 || code === null) {
      console.log('[video] Remotion already running on another port');
    }
  });
});
