...
void test('dashboard-prod points the backend API integration-config secret at the full stage-qualified -v2 name', () => {
  const source = fs.readFileSync(dashboardSpecPath, 'utf8');
