...
def ensure_admin_group_claim_mapping():
    ...
    the group that the application policy has already approved. Keep the claim
    on the standard ``profile`` scope so existing clients need no extra scope.
    """
