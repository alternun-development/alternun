...
declare -A PIPELINE_STAGE=(
  ["alternun-prod"]="production"
  ["alternun-dev"]="production"
  ["alternun-auth-dev"]="production"
  ["alternun-auth-prod"]="production"
)
declare -A PIPELINE_REPO=(
  ["alternun-prod"]="alternun-development/alternun"
  ["alternun-dev"]="alternun-development/alternun"
  ["alternun-auth-dev"]="alternun-development/alternun"
  ["alternun-auth-prod"]="alternun-development/alternun"
)
declare -A PIPELINE_BRANCH=(
  ["alternun-prod"]="master"
  ["alternun-dev"]="develop"
  ["alternun-auth-dev"]="$IDENTITY_BRANCH_DEV"
  ["alternun-auth-prod"]="$IDENTITY_BRANCH_PROD"
)
