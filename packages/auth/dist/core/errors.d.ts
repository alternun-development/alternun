export type AuthErrorCode = 'CONFIG_ERROR' | 'UNSUPPORTED_FLOW' | 'NETWORK_ERROR' | 'PROVIDER_ERROR' | 'SESSION_ERROR' | 'VALIDATION_ERROR' | 'MIGRATION_ERROR';
...
export declare function toAlternunAuthError(error: unknown, fallbackCode?: AuthErrorCode, fallbackMessage?: string): AlternunAuthError;
