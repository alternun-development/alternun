...
export declare function principalToUser(
  principal: Principal,
  overrides?: {
    id?: string;
    avatarUrl?: string;
...
export declare function executionSessionToUser(
  session: ExecutionSession | null,
  fallbackPrincipal?: Principal | null
): User | null;
export declare function issuerSessionToUser(
  session: IssuerSession | null,
  fallbackExecution?: ExecutionSession | null
): User | null;
export declare function buildLinkedAccountsFromIdentity(
  identity: ExternalIdentity,
  type?: LinkedAuthAccount['type']
): LinkedAuthAccount[];
