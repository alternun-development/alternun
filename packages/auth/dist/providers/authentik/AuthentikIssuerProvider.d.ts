...
import type { AlternunSession, ClaimValidationResult, ExecutionSession, IdentityExchangeInput, IssuerDiscoveryConfig, IssuerSession } from '../../core/types';
...
export declare function issuerSessionToCompatUser(session: IssuerSession | null): import("@edcalderon/auth").User | null;
