...
import type { AuthExecutionResult, AuthExecutionSignInOptions, AuthExecutionSignUpInput, AuthExecutionSignUpReferralInput, AuthLinkProviderInput, AuthUnlinkProviderInput, ExecutionSession, LinkedAuthAccount, WalletConnectionBridge } from '../../core/types';
...
export declare class BetterAuthExecutionProvider implements AuthExecutionProvider {
    ...
    signUpWithEmail(email: string, password: string, locale?: string, referral?: AuthExecutionSignUpReferralInput | null): Promise<AuthExecutionResult>;
