import { OIDC_INITIAL_SEARCH, type AuthentikOidcConfig, type OidcClaims, type OidcProvider, type OidcSession, type OidcTokens } from '@edcalderon/auth';
...
export declare function buildAlternunAuthentikOAuthFlowStartUrl(input: BuildAuthentikOAuthFlowStartUrlInput): string;
export { buildAuthentikOAuthFlowStartUrl, resolveAuthentikRedirectUri } from './authentikUrls';
export declare function readPendingAuthentikOAuthProvider(config?: AuthentikOidcConfig): 'google' | 'discord' | null;
...
export declare function startAuthentikOAuthFlow(provider: OidcProvider, config?: AlternunAuthentikOAuthFlowOptions): Promise<void>;
export declare function handleAuthentikCallback(searchString?: string, config?: AuthentikOidcConfig): Promise<OidcSession>;
export { OIDC_INITIAL_SEARCH, type AuthentikOidcConfig, type OidcClaims, type OidcProvider, type OidcSession, type OidcTokens, };
