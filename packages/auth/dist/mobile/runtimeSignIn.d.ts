...
export declare function webRedirectSignIn({ client, provider, redirectTo, authentikProviderHint, forceFreshSession, strategy, }: WebRedirectSignInOptions): Promise<'authentik' | 'supabase' | 'better-auth'>;
