import { z } from 'zod';
import type { AuthExecutionProviderName, EmailProviderName, IdentityIssuerProviderName } from '../core/types';
...
export declare const authEmailProviderSchema: z.ZodEnum<["supabase", "postmark", "tlao"]>;
export declare const authProviderSelectionSchema: z.ZodObject<{
    ...
    emailProvider: z.ZodDefault<z.ZodEnum<["supabase", "postmark", "tlao"]>>;
}, "strip", z.ZodTypeAny, {
    executionProvider: "better-auth" | "supabase";
    issuerProvider: "authentik" | "supabase-legacy";
    emailProvider: "supabase" | "postmark" | "tlao";
}, {
    executionProvider?: "better-auth" | "supabase" | undefined;
    issuerProvider?: "authentik" | "supabase-legacy" | undefined;
    emailProvider?: "supabase" | "postmark" | "tlao" | undefined;
}>;
export declare function normalizeAuthExecutionProvider(value: string | undefined | null): AuthExecutionProviderName;
export declare function normalizeAuthIssuerProvider(value: string | undefined | null): IdentityIssuerProviderName;
export declare function normalizeAuthEmailProvider(value: string | undefined | null): EmailProviderName;
