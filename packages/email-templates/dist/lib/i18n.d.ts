...
export declare const EMAIL_TEMPLATE_KEYS: readonly [
...
export declare function isSupportedEmailLocale(
  value: string | null | undefined
): value is EmailLocale;
export declare function normalizeEmailLocale(
  value: EmailLocale | string | null | undefined,
  fallbackLocale?: EmailLocale
): EmailLocale;
export declare function getEmailTemplateTranslation(
  locale: EmailLocale | string | null | undefined,
  template: EmailTemplateKey,
  fallbackLocale?: EmailLocale
): EmailTemplateTranslation;
export declare function interpolateEmailTemplateText(
  value: string,
  params?: EmailTemplateParams
): string;
export declare function renderEmailTemplateTranslation({
  locale,
  template,
  params,
  fallbackLocale,
...
export declare function createEmailTemplateTranslator({
  locale,
  template,
  fallbackLocale,
}: {
